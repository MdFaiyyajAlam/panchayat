                            ...
                            <div class="card">
                                ...
                                <div class="card-header bg-gradient-moonlit">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a href="{{route('admin.category.delete', $list->id)}}" class="text-light bg-danger nav-action">
                                ...
                                <div id="{{'id'.$list->id}}" class="collapse" data-bs-parent="#accordion">
                                    <div class="card-body d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <a href="{{route('admin.subcategory.delete', $child->id)}}" class="text-light bg-danger nav-action">
                                                <i class='bx bxs-trash bx-xs'></i>
                                            </a>
